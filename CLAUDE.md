...
**What is NOT measured, stated plainly.** No forward-return test of the new columns, as above. The floors themselves are judgments: 1.2 admitted 401 of 1,776 liquidity-filtered rows mid-session on 2026-09-16 (244 strong, 207 weak, 50 in both) and 1.5 admitted 276 of 1,824 after the close, but nothing shows those cutoffs select better tickers than neighbouring values. The breadth coefficient was chosen, not swept. **TradingView's own Relative Volume at Time study has never been read off a crypto chart**, so the UTC-midnight anchor is verified against the vendor's `volume` column but not against the vendor's own plot. And **the warm-up has never been timed across the full universe**: 6 workers are projected to cover ~1,900 tickers in 3–5 minutes against the ~1.7 minutes of the yfinance warm-up they replace, which is why the guidance is to launch before the bell — but that projection comes from a 60-symbol list, not from a full run.
