...
**The pinned strip is what actually catches that case.** On the same reconstructed board Cybersecurity is **pin #4** of five, at 12.1% share, naming CRWD, FTNT, S and VRNS — visible above the board with no scroll and no click, while ranking 10th–11th by strength. That asymmetry is the whole argument for surfacing over ranking: the ranking lever tops out two places short, and the display lever clears it outright.
